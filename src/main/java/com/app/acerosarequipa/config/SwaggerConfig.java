package com.app.acerosarequipa.config;
...
public class SwaggerConfig {
    ...
    public Docket productApi() {
        ApiInfo apiInfo = new ApiInfoBuilder().title("Api Rest Aceros Arequipa - Reto Técnico")
                .description(
        ...
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo).select()
                .apis(RequestHandlerSelectors.basePackage("com.app.acerosarequipa.controller"))
